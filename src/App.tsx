            ...
            <div className="bg-[#121820]/40 border border-white/5 p-8 md:p-10 rounded-3xl backdrop-blur-sm shadow-2xl relative">
              <form onSubmit={(e) => e.preventDefault()} className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label className="text-xs font-bold text-gray-400 mb-2 block">Name *</label>
                    <input 
                      type="text" 
                      required
                      placeholder="Ihr Name"
                      className="w-full bg-[#0d131a]/80 border border-white/10 rounded-xl px-4 py-3.5 text-sm text-white focus:border-orange-500 focus:ring-1 focus:ring-orange-500 transition-all outline-none"
                    />
                  </div>
                  <div>
                    <label className="text-xs font-bold text-gray-400 mb-2 block">Telefon</label>
                    <input 
                      type="tel" 
                ...
                {/* Gewünschte Leistung */}
                <div>
                  <label className="text-xs font-bold text-gray-400 mb-2 block">Gewünschte Leistung</label>
                  <select className="w-full bg-[#0d131a]/80 border border-white/10 rounded-xl px-4 py-3.5 text-sm text-white focus:border-orange-500 outline-none cursor-pointer">
                ...
                {/* Ihre Nachricht */}
                <div>
                  <label className="text-xs font-bold text-gray-400 mb-2 block">Ihre Nachricht</label>
                  <textarea 
                    rows={4} 
                    placeholder="Beschreiben Sie kurz Ihr Anliegen - Adresse des Objekts, Größe, was gemacht werden soll..."
                    className="w-full bg-[#0d131a]/80 border border-white/10 rounded-xl px-4 py-3.5 text-sm text-white focus:border-orange-500 outline-none resize-none"
                  />
                </div>

                {/* Checkbox */}
                <label className="flex items-start gap-3 text-xs text-gray-400 leading-relaxed cursor-pointer select-none">
                  <input 
                    type="checkbox" 
                    required
                  ...
                  />
                  <span>
                    Ich habe die <a href="#" className="text-orange-500 hover:underline">Datenschutzerklärung</a> gelesen und stimme der Verarbeitung meiner Daten zur Bearbeitung der Anfrage zu.
                  </span>
                </label>
                ...
                <button 
                  type="submit"
                  className="w-full bg-orange-500 hover:bg-orange-600 text-white font-bold py-4 rounded-xl shadow-lg shadow-orange-500/20 hover:shadow-orange-500/35 transition-all duration-150 active:scale-[0.99] cursor-pointer text-center text-sm tracking-wide"
                >
                  Kostenloses Angebot anfragen
                </button>

                <p className="text-center text-[0.7rem] text-gray-500 mt-4">
